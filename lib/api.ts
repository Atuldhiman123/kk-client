...
export const DEFAULT_GEMSTONES: GemstoneDetail[] = [
  {
    ...
    name: 'Ruby (Manik)',
    slug: 'ruby-manik',
    shortDescription: 'Natural Certified Burma Ruby for Sun (Surya) alignment, leadership & confidence.',
    description: 'Burma Ruby (Manikya) is the gem of the Sun. Wearing a high quality natural ruby enhances self-confidence, leadership qualities, authority, and vitality.',
    benefits: 'Boosts confidence, improves relations with father and authority figures, aids cardiac health.',
    whoShouldWear: 'Recommended for Leo (Simha Rashi) ascendants or those with weak Sun placement.',
    weightOptions: '3.25 Ratti, 4.5 Ratti, 5.25 Ratti, 6.5 Ratti',
    certification: '100% Lab Certified Natural Unheated Ruby with Authenticity Card',
    careInstructions: 'Clean with warm soapy water and soft brush. Avoid harsh chemical cleaners.',
    price: '4500.00',
    image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=600&q=80',
    isFeatured: true,
    isActive: true,
    images: [{ id: 'img-1', imageUrl: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=600&q=80', sortOrder: 0 }],
    related: [],
  },
  {
    id: 'gem-2',
    ...
    shortDescription: 'Unheated Ceylon Yellow Sapphire for Jupiter (Guru) blessing, wealth & wisdom.',
    ...
    isFeatured: true,
    isActive: true,
    images: [{ id: 'img-2', imageUrl: 'https://images.unsplash.com/photo-1615655406736-b37c4fabf923?auto=format&fit=crop&w=600&q=80', sortOrder: 0 }],
    related: [],
  },
  {
    id: 'gem-3',
    ...
    isFeatured: true,
    isActive: true,
    images: [{ id: 'img-3', imageUrl: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=600&q=80', sortOrder: 0 }],
    related: [],
  },
  {
    id: 'gem-4',
    ...
    isFeatured: true,
    isActive: true,
    images: [{ id: 'img-4', imageUrl: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&w=600&q=80', sortOrder: 0 }],
    related: [],
  },
];
