          ...
          {testimonials.map((testimonial) => (
            ...
            >
              ...
              <div className="mt-5 sm:mt-6 flex items-center gap-3 border-t border-orange-100 pt-4">
                ...
                <div>
                  <div className="text-xs sm:text-sm font-bold text-neutral-900">{testimonial.name}</div>
                  {testimonial.location && (
                    <div className="text-[11px] sm:text-xs text-neutral-500 font-medium">{testimonial.location}</div>
                  )}
                </div>
              </div>
            </div>
