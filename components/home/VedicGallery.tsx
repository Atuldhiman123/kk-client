...
export function VedicGallery() {
  ...
  return (
    <section className="bg-gradient-to-b from-[#FFF8E1]/40 via-[#FFFDF9] to-orange-50/20 py-20 border-t border-orange-200/40">
            ...
            >
              <div className="relative h-48 w-full overflow-hidden bg-orange-50">
                <img
                  ...
                  loading="lazy"
                />
                <span className="absolute top-3 left-3 rounded-full bg-orange-600 px-3 py-1 text-[10px] font-extrabold uppercase tracking-wider text-white shadow-sm">
                  {practice.badge}
                </span>
              </div>
